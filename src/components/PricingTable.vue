...
<template>
  <div
    id="pricing-table"
    class="w-[385px] h-[807px] bg-gradient-to-b from-grad-1 to-grad-2 p-[2px] rounded-[20px] overflow-hidden"
  >
    <div
      class="w-full h-full bg-base rounded-[20px] flex flex-col gap-[28px] px-[24px] pt-[65px]"
    >
      <div
      ...
      <div class="h-[44px] flex items-center gap-[15px]">
        <div
          class="h-full flex items-center px-[12px] bg-white rounded-[6px]"
      ...
      <div
        class="h-[61px] rounded-full bg-white flex justify-center items-center gap-[4px] text-grad-2"
      >
      ...
      <div class="flex flex-col gap-[10px]">
        <div
          ...
          v-for="item in props.item.features"
          :key="item.id"
        >
